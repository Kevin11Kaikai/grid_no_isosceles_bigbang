#!/usr/bin/env python3
"""Wave3: Type1 defect xlarge after Type0 s501.

Type1 pure was INFEAS at smaller enlarge; defect remains open.
"""
...
def main():
    ...
    seed = int(os.environ.get("W3_ORBIT_SEED", "601"))
    ...
    ck = save_checkpoint(res, f"w3_xlarge_n100_t1_defect_s{seed}")
    ...
    path = os.path.join(exp, f"xlarge_t1_defect_s{seed}.json")
