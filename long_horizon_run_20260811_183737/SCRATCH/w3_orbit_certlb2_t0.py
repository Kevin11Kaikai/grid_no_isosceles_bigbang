#!/usr/bin/env python3
"""Wave3: Type0 defect with cert_lb2 defect ranking (new universe truncation)."""
...
def main():
    try:
        ...
        pass
    time_s = float(os.environ.get("W3_ORBIT_TIME", "2700"))
    ...
    ck = save_checkpoint(res, f"w3_certlb2_n100_t0_defect_s{seed}")
    ...
    path = os.path.join(exp, f"certlb2_t0_defect_s{seed}.json")
