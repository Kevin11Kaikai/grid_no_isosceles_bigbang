...
Copied from iso6/experiments/four_direction_linekill.py (snapshot 2026-08-16).
This copy is intentionally NOT imported from iso6 and will NOT be kept in sync.
